...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			// 主页横幅副标题
			subtitle: [
				"Upon Grey Ashes, I Wander Alone",
				"Through Painted Lies, I See the Truth",
				"Beneath Silent Stars, I Smile Alone",
				"With Flowing Hair, I Chase the Wind",
				"Upon This Broom, I Ride to Nowhere",
				"In My Own Story, I Am the Only Truth",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
